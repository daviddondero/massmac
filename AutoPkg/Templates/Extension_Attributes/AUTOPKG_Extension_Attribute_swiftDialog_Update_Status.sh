#!/bin/bash
##########################################################################
# Jamf Extension Attribute: AutoPkg swiftDialog Update Status
#
# Purpose:
#   Checks whether swiftDialog is installed and up-to-date.
#   Compares the installed version against AutoPkg latest version (%version%).
#
# Functionality:
#   1. Checks /Library/Application Support/Dialog/Dialog.app for installation.
#   2. Reads the installed version from Info.plist (CFBundleShortVersionString).
...
APP_PATH="/Library/Application Support/Dialog/Dialog.app"
...
# ----------------------------------------------------------------------
# Determine installed version and update status
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Safely remove old JSON files for this app (Bash 3.x compatible)
# ----------------------------------------------------------------------
